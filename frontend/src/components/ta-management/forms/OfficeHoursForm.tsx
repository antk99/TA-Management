            ...
            <Row className="p-0 mt-2">
              <Col lg={6} xs={12} className="mb-2">
                <InputGroup>
                  ...
                  <Form.Select
                    onChange={(e) =>
                      updateOfficeHourField(index, "day", e.target.value)
                    }
              ...
              <Col lg={6} xs={12} className="mb-2">
                <InputGroup>
                  ...
                  <Form.Control
                    ...
                    onChange={(e) =>
                      updateOfficeHourField(index, "location", e.target.value)
                    }
                  />
                </InputGroup>
              </Col>
            ...
            <Row className="p-0 mt-2">
              <Col lg={4} md={12} className="mb-2">
                <InputGroup>
                  ...
                  <Form.Select
                    onChange={(e) =>
                      updateOfficeHourField(index, "startTime", e.target.value)
                    }
              ...
              <Col lg={4} md={12} className="mb-2">
                <InputGroup>
                  ...
                  <Form.Select
                    onChange={(e) =>
                      updateOfficeHourField(index, "endTime", e.target.value)
                    }
